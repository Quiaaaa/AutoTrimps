...
const getGameData = {
	...
	chalStacks: () => {
		for (const [chal, stacks] of Object.entries(stackChallenges)) {
...
const graphList = [
	...
	new Graph("chalStacks", false, "Challenge Stacks", {
		conditional: () => { return Object.keys(stackChallenges).some((chal) => { return challengeActive(chal); }) }
	}),
